...
contract SKBEATTokenSaleTest is Test {
    ...
    function setUp() public {
        ...
        // Deploy tokens
        skbeatToken = new SKBEATToken("SKBEAT Token", "SKBEAT", "ipfs://bafkreidm3tymj6bzntjux4rxtspsx4jukobknprxhzq76aa2k34aymtdo4");
    ...
    function test_SetTokenURI_Success() public {
        string memory newURI = "ipfs://newtokenuri";
        skbeatToken.setTokenURI(newURI);
        assertEq(skbeatToken.tokenURI(), newURI);
    }

    function test_SetTokenURI_RevertEmptyString() public {
        vm.expectRevert("Empty URI");
        skbeatToken.setTokenURI("");
    }
    ...
    function testFuzz_BuyTokens_DefaultPrice(uint256 skbeatAmount) public {
        ...
        uint256 denominator = uint256(tokenSale.skbeatPerUsdc()) * 100;
uint256 expectedUsdc =
    (skbeatAmount + denominator - 1) / denominator;
